...
<meta name="csrf-token" content="66+thZklflTgs0MG+NwFVU1jPa7BIF3qlsT/GPOphGZNZi0Oi2KFmZhzErpK7lrgTA+OlWJHw+KcEgcOa4J3VQ==" />
...
<form id="new_ldap_user" class="gl-show-field-errors" action="/users/auth/ldapmain/callback" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="uwoXX3TzdHx+9RhR6PmwXf09YpuwZC4dvwsDd2q7BZodw5fUZrSPsQY1Se1ay+/o/FHRoBMDsBW13fth8pD2qQ==" /><div class="form-group">
...
<div class="login-body">
<form class="new_user gl-show-field-errors" aria-live="assertive" id="new_user" action="/users/sign_in" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="7bewWxYCDPve89vwZKpsqSGAEjpq+eq9b4KDAcAUZhBLfjDQBEX3NqYzikzWmDMcIOyhAcmedLVlVHsXWD+VIw==" /><div class="form-group">
